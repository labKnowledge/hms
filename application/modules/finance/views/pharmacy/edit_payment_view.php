                                            ...
                                            <?php if (!empty($payment->id)) { ?>
                                                <div class="col-md-8 payment pad_bot">
                                                    <div class="col-md-8 payment_label"> 
                                                        <label for="exampleInputEmail1">  <?php echo "Pharmacy ".lang('invoice_id'). " : 00" . $payment->id; ?></label>
                                                    </div> 
                                                ...
                                                <div class="col-md-8">
                                                        ...
                                                        <select class="form-control m-bot15 js-example-basic-single" id="inv_select" name="invoice" value=''>
                                                            <option value=0><?php echo 'Select AIO Invoice'; ?></option>
                                                            <?php 
                                                            $Invoices = $this->db->order_by('id', 'DESC')->get_where('payment', array('finalize_Status' => 'Active'));
                                                            foreach ($Invoices->result() as $Invoice) { ?>
                                                                <option value="<?php echo $Invoice->id; ?>"<?php
                                                                if (!empty($Invoice->id)) {
                                                                    if ($payment->invoice == $Invoice->id) {
                                                                        echo 'selected';
                                                                    }
                                                                }
                                                                ?> ><?php echo $Invoice->id.' ('.$Invoice->patient_name.')' ?> </option>
                                                            <?php } ?>
                                                        </select>
                                                        </div>                                             
                                            <?php } ?>
