                        ...
                        <form role="form" class="clearfix pos form1" id="editPaymentForm" action="finance/pharmacy/addPayment" method="post" enctype="multipart/form-data">
                            <div class="col-md-6 row">
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9 row">
                                            <select name="category_name[]" id="" class="multi-select" multiple="" id="my_multi_select3">
                                                ...
                                                ?>
                                                        <option class="ooppttiioonn" data-id="<?php echo $medicine->id; ?>" data-s_price="<?php echo (float) $medicine->s_price; ?>" data-m_name="<?php echo $medicine->name; ?>" data-c_name="<?php echo $medicine->company; ?>" data-cs="<?php echo $medicine->quantity; ?>" value="<?php echo $medicine->id; ?>" <?php
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control m-bot15 js-example-basic-single" id="inv_select" name="invoice" value=''>
                                        <option value=0><?php echo 'Select Invoice'; ?></option>
                                        <?php 
                                        $Invoices = $this->db->order_by('id', 'DESC')->get_where('payment', array('finalize_Status' => 'Active'));
                                        foreach ($Invoices->result() as $Invoice) { ?>
                                            <option value="<?php echo $Invoice->id; ?>"><?php echo $Invoice->id.' ('.$Invoice->patient_name.')' ?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div> 
