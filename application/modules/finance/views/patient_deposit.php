        ...
        <section class="no-print col-md-8">
            ...
            <div class=" panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="patient-deposit-editable-sample">
                        <thead>
                            <tr>
                            ...
                            ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print">
                                                ...
                                                ?><a class="btn btn-info width_auto" title="<?php echo lang('edit'); ?>" style="width: 20%;" href="finance/editPayment?id=<?php echo $payment->id; ?>"><i class="fa fa-edit"> </i></a><?
                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                            if ($this->ion_auth->in_group(array('Accountant', 'Receptionist', 'Nurse', 'Doctor'))) {
                                                                                                                                                                                                                                                if ($payment->finalize_Status == 'Active') {
                                                                                                                                                                                                                                                ?><a class="btn btn-info width_auto" title="<?php echo lang('edit'); ?>" style="width: 20%;" href="finance/editPayment?id=<?php echo $payment->id; ?>"><i class="fa fa-edit"> </i></a><?
                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                            } ?>
                                                <a class="btn invoicebutton width_auto" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 20%;" href="finance/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-file-text"></i> </a>
                                                <?php if ($this->ion_auth->in_group(array('admin'))) {
                                                ?><a class="btn btn-info delete_button width_auto" title="<?php echo lang('delete'); ?>" style="width: 20%;" href="finance/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a><?
                                                                                                                                                                                                                                                                                                                            if ($payment->finalize_Status == 'Active') {
                                                                                                                                                                                                                                                                                                                            ?>
                                                        <a class="btn btn-info width_auto" title="<?php echo "Finalize"; ?>" style="width: 20%;" href="finance/finalize?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to Finalize And Lock this Payment?');"><i class="fa fa-check"></i> </a>
                                                    <?
                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                        }
                                ...
                                ?>
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="no-print">
                                                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist', 'Doctor', 'Nurse'))) { ?>
