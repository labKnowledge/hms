        ...
        <section class="col-md-6">
            <div class="panel panel-primary" id="invoice">
                ...
                <div class="panel-body" style="font-size: 10px;">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            if (!empty($payment->category_name)) {
                                ...
                                $pharmacy_amount=0;
                                $pharmacy_gross=0;
                                $pharmacycategory_name="";
                                $pharmacy_payment = $this->db->get_where('pharmacy_payment', array('invoice' => $payment->id));
                                if($pharmacy_payment->num_rows()!=0){
                                    $pharmacy_amount = $pharmacy_payment->result()[0]->amount;
                                    $pharmacy_gross = $pharmacy_payment->result()[0]->gross_total;
                                    $pharmacycategory_name = $pharmacy_payment->result()[0]->category_name;
                                }
                            ...
                            <?php
                                ...
                                if($pharmacy_payment->num_rows()!=0){
                                    $category_name1 = explode(',', $pharmacycategory_name);
                                    foreach ($category_name1 as $category_name2) {
                                        $category_name3 = explode('*', $category_name2);
                                        if ($category_name3[1] > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    echo $current_medicine->name . ' ('.$current_medicine->company.')';
                                                    ?>
                                                </td> 
                                                <td class=""><?php echo $settings->currency; ?> <?php echo $category_name3[1]; ?> </td>
                    ...
                    <div class="">
                        <div class="col-lg-6 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                <li><strong><?php echo lang('sub_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $payment->amount+$pharmacy_amount; ?></li>
                                ...
                                <li><strong><?php echo lang('grand_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $g = $payment->gross_total+$pharmacy_gross; ?></li>
                                <li><strong><?php echo lang('amount_received'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $r = $this->finance_model->getDepositAmountByPaymentId($payment->id)+$pharmacy_amount; ?></li>
                    ...
                    <? if($pharmacy_payment->num_rows()!=0){
                                    echo "Pharmacy Invoice No : 00" . $pharmacy_payment->result()[0]->id;
                    }?>
                    <hr>
                    </div>
