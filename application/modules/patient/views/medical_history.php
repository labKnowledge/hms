            ...
            <aside class="profile-nav">
                <section class="">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>  <?php echo lang('date'); ?><span class="label pull-right r-activity"><?php echo $patient->add_date; ?></span></li>
                ...
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                         ...
                         <li class="">
                            <a data-toggle="tab" href="#home2"><?php echo "Vitals/Others"; ?></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#home3"><?php echo "Procedure"; ?></a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                         ...
                         <li class="">
                            <a data-toggle="tab" href="#rad"><?php echo "Radiology"; ?></a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="home" class="tab-pane">
                            <div class="">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample-1">
                                        <thead>
                                            <tr>
                                                <th><?php echo lang('date'); ?></th>
                                                <th><?php echo lang('doctor'); ?></th>
                                        ...
                                        <tbody>
                                            <?php foreach ($medical_histories as $medical_history) { ?>
                                                <tr class="">
                                                    ...
                                                    <td><?php echo $medical_history->authorName . '('.$medical_history->authorEmail.')' ?></td>
                                                    ...
                                                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                        <td class="no-print">
                                                            ...
                                                            if($current_user==$medical_history->authorID){?>
                            ...
                            <div class="">
                                ...
                                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                    ...
                                    <?
                                            if ($this->ion_auth->in_group(array('admin', 'Doctor'))) {
                                              ?> 
                                              <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#myProcedureModal">
                                            <i class="fa fa-plus-circle"> </i> <?php echo lang('add_new'); ?> 
                                            </a> 
                                            <?
                                            }
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample-7">
                                        <thead>
                                            <tr>
                                                <th><?php echo lang('date'); ?></th>
                                                <th><?php echo lang('doctor'); ?></th>
                                        ...
                                        <tbody>
                                            <?php foreach ($procedure_histories as $medical_history) { ?>
                                                <tr class="">
                        ...
                        <div id="home2" class="tab-pane">
                            <div class="">
                                ...
                                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                    <div class=" no-print">
                                        <?
                                              ...
                                              ?> 
                                              <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#myVitalModal">
                                                <i class="fa fa-plus-circle"> </i> <?php echo lang('add_new'); ?>
                                            </a> <?
                                            }
                                            ?>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample-6">
                                        <thead>
                                            <tr>
                                                <th><?php echo lang('date'); ?></th>
                                        ...
                                        <tbody>
                                            <?php foreach ($vital_histories as $medical_history) { ?>
                                                <tr class="">
                        ...
                        <div id="about" class="tab-pane"> <div class="">
                                ...
                                <?php } ?>
                                <div class="adv-table editable-table ">
                                <table class="table table-striped table-hover table-bordered" id="editable-sample-2">
                                        <thead>
                                            <tr>
                        ...
                        <div id="lab" class="tab-pane"> <div class="">
                                <div class="adv-table editable-table ">
                                <table class="table table-striped table-hover table-bordered" id="editable-sample-3">
                                        <thead>
                                            <tr>
                        ...
                        <div id="rad" class="tab-pane"> <div class="">
                                <div class="adv-table editable-table ">
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample-4">
                                        <thead>
                                            <tr>
                                                <th><?php echo lang('id'); ?></th>
                                                <th><?php echo "Radiology Date"; ?></th>
                                                <th><?php echo lang('doctor'); ?></th>
                                                <th class="no-print"><?php echo lang('options'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($rad as $rad) { ?>
                                                <tr class="">
                                                    ...
                                                    <td><?php echo date('m/d/Y', $rad->date); ?></td>
                                                    <td>
                                                        <?php
                                                        $doctor_details = $this->doctor_model->getDoctorById($rad->doctor);
                                                        if (!empty($doctor_details)) {
                                                            $lab_doctor = $doctor_details->name;
                                                        } else {
                                                            $lab_doctor = '';
                                                    ...
                                                    <td class="no-print">
                                                        <a class="btn btn-info btn-xs btn_width" href="lab/invoice?id=<?php echo $rad->id; ?>"><i class="fa fa-eye"> <?php echo lang('report'); ?> </i></a>   
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                        ...
                        <div id="contact" class="tab-pane"> 
                            <div class="">
                                ...
                                <?php } ?>
                                <div class="adv-table editable-table ">
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample-5">
                                        <thead>
                                            <tr>
            ...
            <div class="modal-body">
                <form role="form" action="patient/addMedicalHistory" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="hidden" name="case_type" id="exampleInputEmail1" value='Default' placeholder="" readonly="">
                    </div>
                    <div class="form-group col-md-12">
...
<div class="modal fade" id="myProcedureModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  Add Procedure Request</h4>
            </div> 
            <div class="modal-body">
                <form role="form" action="patient/addMedicalHistory" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="title" id="exampleInputEmail1" value='' placeholder="">
                        <input type="hidden" name="case_type" id="exampleInputEmail1" value='Procedure' placeholder="" readonly="">
                    </div>
                    <div class="form-group col-md-12">
                        <label class=""><?php echo lang('description'); ?></label>
                        <div class="">
...
<div class="modal fade" id="myVitalModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> Add Vitals/Nurse Notes</h4>
            </div> 
            <div class="modal-body">
                <form role="form" action="patient/addMedicalHistory" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('date'); ?></label>
                        <input type="text" class="form-control form-control-inline input-medium default-date-picker" name="date" id="exampleInputEmail1" value='' placeholder="" readonly="">
                        <input type="hidden" name="case_type" id="exampleInputEmail1" value='Nurse' placeholder="" readonly="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="title" id="exampleInputEmail1" value='' placeholder="">
            ...
            <div class="modal-body">
                <form role="form" id="medical_historyEditForm" class="clearfix row" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('date'); ?></label>
                        <input type="text" class="form-control form-control-inline input-medium default-date-picker" name="date" id="exampleInputEmail1" value='' placeholder="" readonly="">
                        <input type="hidden" name="case_type" id="exampleInputEmail1" value='' placeholder="" readonly="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="title" id="exampleInputEmail1" value='' placeholder="">
                                                            ...
                                                            $(document).ready(function () {
                                                                $(".editbutton").click(function (e) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        $('#medical_historyEditForm').find('[name="case_type"]').val(response.medical_history.case_type).end()
