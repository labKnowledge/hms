...
<section id="main-content">
    <section class="wrapper site-min-height">
                ...
                <div class=""> 
                    <form role="form" action="patient/addMedicalHistory" class="clearfix" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control m-bot15 js-example-data-ajax" name="patient_id" value=''>
                        ...
                        <input type="hidden" name="redirect" value='patient/caseList?caseType=Default'>
        ...
        <?
        if($_GET['caseType']=='Nurse'){
            if ($this->ion_auth->in_group(array('admin','Nurse'))) {
                ?>
                <section class="col-md-5">
                <header class="panel-heading">
                    <?php echo lang('add'); ?> <?php echo "Vitals/Others" ?> 
                </header> 
                ...
                <div class=""> 
                    <form role="form" action="patient/addMedicalHistory" class="clearfix" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            <label class=""><?php echo "Description"; ?></label>
                            <textarea class="form-control ckeditor" name="description" value="" rows="70" cols="70"></textarea>
                        </div>
                        <input type="hidden" name="redirect" value='patient/caseList?caseType=Nurse'>
                        <section class="col-md-12">
                            <button type="submit" name="submit" class="btn btn-info submit_button pull-right"><?php echo lang('submit'); ?></button>
                        </section>
                    </form>
        ...
        <section class="col-md-7">
            <header class="panel-heading">
                <?php
                if($_GET['caseType']=='Nurse'){
                    echo lang('all'); ?> <?php echo "Nurse Vitals/Others Notes"; 
                }
                else{
                    echo lang('all'); ?> <?php echo lang('case'); 
                }
                 ?>
            </header> 
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%"><?php echo lang('nurse'); ?></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="medical_historyEditForm" class="clearfix" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('patient'); ?></label>
                        <select class="form-control m-bot15 js-example-data-ajax patient" name="patient_id" value=''> 
                        </select>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                    ...
                    <div class="form-group col-md-12">
                        <label class=""><?php echo lang('description'); ?></label>
                        <div class="">
                            <textarea class="ckeditor form-control editor" id="editor" name="description" value="" rows="10">wdwdw</textarea>
                        </div>
                    </div>
                    <input type="hidden" name="id" value=''>
                    <?
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                if($_GET['caseType']=='Nurse'){
                    echo "Nurse Vitals/Others Note"; ?> <?php echo lang('details'); 
                }
                else{
                    echo lang('case'); ?> <?php echo lang('details'); 
                }
                    ...
                    <div class="form-group col-md-12 row">
                        <div class="form-group col-md-6 case_date_block">
                            <label for="exampleInputEmail1"><?php
                             ...
                             if($_GET['caseType']=='Nurse'){
                                echo "Note"; ?> <?php echo lang('creation'); ?> <?php echo lang('date'); 
                            }
                            else{
                                echo lang('case'); ?> <?php echo lang('creation'); ?> <?php echo lang('date'); 
                            }
                             ?></label>
...
<script>
    ...
    $(document).ready(function () {
        var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "patient/getCaseList?caseType=<?echo $_GET['caseType'];?>",
                type: 'POST',
            },
            scroller: {
