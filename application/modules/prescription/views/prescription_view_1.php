    ...
    <section class="wrapper site-min-height">
        ...
        <div class="col-md-8 panel bg_container margin_top" id="prescription">
            ...
            <div class="bg_prescription">
                ...
                <div class="panel-body">
                    <div class="">
                        <!-- <h5 class="col-md-4 prescription">
                            <?php 
                               // echo lang('date'); ?> : <?php 
                        ...
                        <h5 class="col-md-4 prescription">
                            ...
                            <?php 
                                if (!empty($prescription->date)) {
                                    $convertedTimestamp = $prescription->date + 32400; // Add 9 hours (9 hours * 60 minutes * 60 seconds)
                                    echo date('d-m-Y', $convertedTimestamp);
                                }
                            ?>
                        </h5>

                        <h5 class="col-md-3 prescription"><?php echo lang('prescription'); ?> #: <?php echo $prescription->id; ?></h5>
                    </div>
                </div>
