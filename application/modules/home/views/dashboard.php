...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <meta name="author" content="Georgennd">
        <meta name="keyword" content="Ouraim International HMS System">
                                ...
                                <li id="header_notification_bar" class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                        ...
                                        <span class="badge bg-warning">   
                                            <?php
                                            $this->db->where('hospital_id', $this->hospital_id);
                                            //$this->db->where('converted_date', '2023-08-12');
                                            $this->db->where('converted_date', date('Y-m-d'));
                                            $query = $this->db->get('prescription_medicine_view');
                                            $query = $query->result();
                                            foreach ($query as $prescriptions) {
                                                $prescription_number[] = '1';
                                            }
                                            if (!empty($prescription_number)) {
                                                echo $prescription_number = array_sum($prescription_number);
                                            } else {
                                                $prescription_number = 0;
                                                echo $prescription_number;
                                            }
                                            ?>
                                        </span>
                                    </a>
                                        ...
                                        <li>
                                            <p class="yellow"><?php
                                                ...
                                                if ($prescription_number <= 1) {
                                                    echo lang('Prescription Registered Today');
                                                } else {
                                                    echo lang('Prescriptions Registered Today');
                                                }
                                                ?> </p>
                                        </li>    
                                        <li>
                                    
                                            <a href="prescription/all"><p class="green">See All Prescriptions</p></a>
                                        </li>
                                    </ul>
                                </li>
                        <?php } ?>
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <?php
                            if ($this->ion_auth->in_group(array('Laboratorist'))) {
                                $laboratorist_ion_id = $this->ion_auth->get_user_id();
                                $Laboratorist_Type = $this->db->get_where('laboratorist', array('ion_user_id' => $laboratorist_ion_id))->row()->type;
                            }
                            ?>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                                ...
                                <li> <li class="sub-menu">
                                    ...
                                    <ul class="sub"> 
                                        ...
                                        <?php if (!$this->ion_auth->in_group(array('Accountant', 'Receptionist'))) { ?>
                                            <li><a href="patient/caseList?caseType=Default"><i class="fa fa-book"></i><?php echo lang('case'); ?> <?php echo lang('manager'); ?></a></li>
                                            <li><a href="patient/caseList?caseType=Nurse"><i class="fa fa-book"></i><?php echo "Nurse Vitals/Others"; ?> <?php echo lang('manager'); ?></a></li>
                            ...
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php if (in_array('laboratorist', $this->modules)) { ?>
                                        <li><a href="laboratorist?type=lab"><i class="fa fa-user"></i><?php echo lang('laboratorist'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('laboratorist', $this->modules)) { ?>
                                        <li><a href="laboratorist?type=Rad"><i class="fa fa-user"></i><?php echo "Radiologist" ?></a></li>
                                    <?php } ?>
                        ...
                        if ($this->ion_auth->in_group(array('Receptionist'))) {
                            ...
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li>
                                    <a href="lab/lab1?type=lab">
                                        <i class="fa fa-medkit"></i>
                                        <span><?php echo lang('lab_reports'); ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="lab/lab1?type=Rad">
                                        <i class="fa fa-medkit"></i>
                                        <span><?php echo "Radiology Reports"; ?></span>
                                    </a>
                                </li>
                            <?php } ?>
                            <?php
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor'))) { ?>
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a  href="lab?type=Default"><i class="fa fa-file"></i><?php echo lang('lab_reports'); ?></a></li>
                                        <li><a  href="lab/addLabView?type=Default"><i class="fa fa-plus-circle"></i><?php echo lang('add_lab_report'); ?></a></li>
                                        <li><a  href="lab/template?type=Default"><i class="fa fa-plus-circle"></i><?php echo lang('lab')." ".lang('template'); ?></a></li>
                                    </ul>
                                </li>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa  fa-flask"></i>
                                        <span><?php echo "Radiology" ?></span>
                                    </a>
                                    <ul class="sub">
                                        <li><a  href="lab?type=Rad"><i class="fa fa-file"></i><?php echo "Radiology Reports" ?></a></li>
                                        <li><a  href="lab/addLabView?type=Rad"><i class="fa fa-plus-circle"></i><?php echo "Add Radiology Report" ?></a></li>
                                        <li><a  href="lab/template?type=Rad"><i class="fa fa-plus-circle"></i><?php echo "Radiology " . lang('template'); ?></a></li>
                                    </ul>
                                </li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        <?php if (in_array('finance', $this->modules)) { ?>
                                            <li> <a href="finance/dailyReport">  <i class="fa fa-dashboard"></i>   <span><?php echo "Daily Report"; ?></span> </a></li>
                        ...
                        <?php if ($this->ion_auth->in_group('Accountant')) { ?>
                            <?php if (in_array('finance', $this->modules)) { ?>
                                ...
                                <li>
                                    <a href="finance/dailyReport" >
                                        <i class="fa fa-book"></i>
                                        <span> <?php echo "Daily Report"; ?> </span>
                                    </a>
                                </li>
                            <?php } ?>
                        <?php } ?>
