                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <select class="form-control m-bot15 js-example-data-ajax pos_select" id="pos_select" name="patient" value=''> 
                                        ...
                                        <option value="<?php echo $selectedLabPatientId; ?>" selected><?php echo $selectedLabPatientName; ?></option>
                            ...
                            <input type="hidden" name="type" id="exampleInputEmail1" value=<?php echo $type?> placeholder="" readonly="">
                            ...
                            if (!empty($lab_single)) {
                                echo 'lab?id=' . $lab_single->id.'&type='.$type;
                            } else {
                                echo 'lab?type='.$type;
                            }
                            ?>">
        ...
        <section class="col-md-7">
            <header class="panel-heading">
                ...
                <?
                    if($type=="Rad"){
                        ?>
                        <a href="lab/addLabView?type=Rad">
                            <div class="btn-group pull-right">
                                <button id="" class="btn green btn-xs">
                                <i class="fa fa-plus-circle"></i> <?php echo "Add Radiology Report" ?>                                
                                </button>
                            </div>
                        </a>
                        <?
                    ...
                    ?>
                    <a href="lab/addLabView?type=Default">
                            <div class="btn-group pull-right">
                                <button id="" class="btn green btn-xs">
