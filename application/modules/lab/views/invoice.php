        ...
        <section class="col-md-6">
            ...
            <div class="col-md-5 no-print" style="margin-top: 20px;">
                <div class="text-center col-md-12 row">
                    <a href="lab?type=<?echo $lab->type?>" class="btn btn-info btn-sm info pull-left"><i class="fa fa-arrow-circle-left"></i>  <?php
                    if($lab->type=='Rad'){
                        echo "Back To Rad Module";
                    }
                    else{
                        echo lang('back_to_lab_module'); 
                    }
                    ...
                    if ($this->ion_auth->in_group(array('admin', 'Laboratorist'))) { 
                        if($Laboratorist_Type=='lab'&&$lab->type=='lab'){
                            ?>
                            <a href="lab?id=<?php echo $lab->id; ?>&type=<?php echo $lab->type; ?>" class="btn btn-info btn-sm blue pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_report'); ?> </a>
                    <?php }
                        if($Laboratorist_Type=='Rad'&&$lab->type=='Rad'){
                            ?>
                            <a href="lab?id=<?php echo $lab->id; ?>&type=<?php echo $lab->type; ?>" class="btn btn-info btn-sm blue pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_report'); ?> </a>
                    <?php }} ?>
                ...
                <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist'))) { ?>
                    <div class="no-print">
                        ...
                        <a href="lab?type=<?echo $lab->type?>" class="pull-left">
                            <div class="btn-group">
