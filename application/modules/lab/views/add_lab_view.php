                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <select class="form-control m-bot15 js-example-data-ajax pos_select" id="pos_select" name="patient" value=''> 
                                        <option value="">Select .....</option>
                                        <option value="add_new" style="color: #41cac0 !important;"><?php echo lang('add_new'); ?></option>
                                        <select id="patientSelector" class="form-control m-bot15 js-example-data-ajax" name="patient" value=''>
                                    </select>
                                    </select>
                                </div> 
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <select class="form-control m-bot15 js-example-basic-multiple template" id="template" name="template" value=''> 
                                        ...
                                        <?
                                            if($type=="Rad"){
                                                foreach ($radtemplates as $template) { ?>
                                                     <option value="<?php echo $template->id; ?>"><?php echo $template->name; ?> </option>
                                                <?}
                                            }
                                            else{
                                                foreach ($labtemplates as $template) { ?>
                                                    <option value="<?php echo $template->id; ?>"><?php echo $template->name; ?> </option>
                                                <?}
                                            }
                                            ?>
                            ...
                            <input type="hidden" name="type" id="exampleInputEmail1" value=<?echo $type?> placeholder="" readonly="">
                            ...
                            if($type=="Rad"){
                                ?>
                                <input type="hidden" name="redirect" value="lab?type=Rad">
                                <?
                            }
                            else{
                                ?>
                                <input type="hidden" name="redirect" value="lab?type=type=Default">
                                <?
                            }
                            ?>
        ...
        <section class="panel col-md-4">
            ...
            <div class="panel panel-primary" style="margin: 2% 3%;">
                ...
                <div class="panel-body" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="text-center corporate-id">
                            ...
                            <?
                            if($type == "Rad"){
                                echo "Radiology Report";
                            }
                            else{
                                echo lang('lab_report');
                            }
                            ?>
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <?
                                        if($type == "Rad"){
                                            ?><label class="control-label"> <?php echo "Radiology" ?> <?php echo lang('report'); ?> <?php echo lang('id'); ?>  </label><?
                                        }
                                        else{
                ...
                <div class="no-print col-md-8 pull-right">
                    <?
                    if($type=="Rad"){
                        ?><a href="lab/addLabView?type=Rad" class=""><?
                    }
                    else{
                        ?><a href="lab/addLabView?type=Default" class=""><?
                    }
                    ?>
