        ...
        <section class="panel col-md-7">
            ...
            <?php
                if (!empty($template->id)){
                    if($_GET['type']=="Rad"){
                        echo "Edit Radiology Report". ' ' . lang('template');
                    }
                    else{
                    ...
                    if($_GET['type']=="Rad"){
                        echo "Add Radiology Report". ' ' . lang('template');
                    }
                    else{
                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addTemplate" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="templatetype" id="exampleInputEmail1" value=<?echo $type?> placeholder="" readonly="">
