...
class Lab_model extends CI_model {
    ...
    function getLabBySearch($search,$type) {
    ...
    function getLabByLimit($limit, $start,$type) {
        $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
        $this->db->where('type',$type);
        $this->db->order_by('id', 'desc');
    ...
    function getRadByPatientId($id) {
        $this->db->order_by('id', 'desc');
        $this->db->where('patient', $id);
        $this->db->where('type', 'rad');
        $query = $this->db->get('lab');
        return $query->result();
    }
    ...
    function getTemplate() {
        $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
        $this->db->where('template_type','lab');
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('template');
        return $query->result();
    }

    function getRadTemplate() {
        $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
        $this->db->where('template_type', 'Rad');
        $this->db->order_by('id', 'desc');
        $query = $this->db->get('template');
        return $query->result();
    }
